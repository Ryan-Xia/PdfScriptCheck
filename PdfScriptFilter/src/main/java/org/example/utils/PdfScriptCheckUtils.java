...
public class PdfScriptCheckUtils {
...
//            System.out.println("namesArray里面共有："+namesArray.size());
    ...
    private static void checkJavaScriptInOpenAction(PDDocument document) throws IOException {
        ...
        System.out.println("------------------CHECK OPENACTION------------------");
        System.out.println("类型为："+document.getDocumentCatalog().getOpenAction());
//        if (document.getDocumentCatalog().getOpenAction() instanceof PDPageFitWidthDestination
//                || document.getDocumentCatalog().getOpenAction() instanceof PDPageFitDestination) {
//            return;
//        }
